...
export default function CommonFormWrapper({ setting }: { setting: ISettingInput }) {
        ...
        <div className="flex items-center justify-between gap-4 p-4 bg-gray-800/40 rounded-xl border border-white/10">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className={`min-w-[140px] ${isDirty ? 'bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white' : 'bg-gray-700 text-gray-400 cursor-not-allowed'}`}
            >
              {isSubmitting ? (
